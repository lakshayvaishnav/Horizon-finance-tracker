...
export default function DashboardLoader() {
    ...
    if (status === 'unauthenticated') {
        return (
            <section className="flex justify-center items-center h-screen bg-black flex flex-col">
                <p className="text-gray-300 text-xl font-semibold">Please log in to access the dashboard.</p>
                <button className='text-white' onClick={() => signIn('google', { callbackUrl: '/dashboard', redirect: true })}>SignIn</button>
            </section>
        );
